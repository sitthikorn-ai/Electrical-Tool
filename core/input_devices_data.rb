  ...
  module ElectricalCalculator
    module InputDevicesData
      ...
      DEVICES_TAB = [
        ...
        ["Consurmer Unit_SQD",                    "Consurmer Unit_SQD.skp",                  "wall"],
        ...
        ["Plug",                                  "Plug.skp",                                "wall"],
        ["Plug 16 A",                             "Plug_16A.skp",                            "wall"],
        ["Plug x 2",                              "Plug_double.skp",                         "wall"],
        ["Plug x 3",                              "Plug_triple.skp",                         "wall"],
        ["Quad Receptacle",                       "Quad receptacle.skp",                     "wall"],
        ...
        ["Touch Screen",                          "TouchScreen.skp",                         "wall"],
